...
<head>
    ...
    <style>
        ...
        .header { background:linear-gradient(135deg,#0f766e,#14b8a6); padding:30px 30px; color:white; display:flex; align-items:center; }

        .logo-circle { width:40px; height:40px; border-radius:999px; background:rgba(255,255,255,0.15); display:flex; align-items:center; justify-content:center; font-weight:700; }

        .header-text { margin-left:12px; }
        .header-text .company { font-size:24px; font-weight:600; opacity:.9; }
        .header-text .sub { font-size:16px; opacity:.75; }
        ...
        .tag { display:inline-flex; align-items:center; font-size:14px; padding:2px 8px; border-radius:999px; background:#ecfeff; color:#0f766e; font-weight:600; margin-top:10px;}
    </style>
</head>
<body>
<div class="wrapper">
